...
public class PendulumRunner {
	...
	public final static double EarthGravity = 9.81;
	public final static double JupiterGravity = 25;
	...
	public static void main(String[] args) {
		...
		/////////////////////////////////////
		GravityModel gEarth = new GravityConstant(EarthGravity);
		GravityModel gJupiter = new GravityConstant(JupiterGravity);		
		////////////////////////////////////
		...
		for (int second = 1; second <= 20; second++) {
			...
			if (second==11) {rp.setGravity(gJupiter); sp.setGravity(gEarth);}
			if (second<=10) {System.out.print("Earth: ");}
